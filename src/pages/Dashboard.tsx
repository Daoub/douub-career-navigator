...
import { Briefcase, FileText, Users, Calendar, Search, Bell, Settings, LogOut, Eye, Clock, Video, BookOpen } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">إليك نظرة عامة على نشاطك المهني اليوم</p>
          </div>
